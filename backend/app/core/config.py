...
class Settings:
    ...
    def __init__(self):
        ...
        # VC analysis pipeline (multi-provider, bring-your-own-key) Configuration
        # These server-side keys are only fallbacks for local CLI runs; in the
        # deployed app the user supplies their own key per request.
        self.ANTHROPIC_API_KEY = os.getenv("ANTHROPIC_API_KEY", "")
        self.DEEPSEEK_API_KEY = os.getenv("DEEPSEEK_API_KEY", "")
        self.VC_LLM_MODEL = os.getenv("VC_LLM_MODEL", "claude-opus-4-8")
        self.VC_LLM_MAX_TOKENS = int(os.getenv("VC_LLM_MAX_TOKENS", "8000"))
